...
namespace KleinGordonPDE
{
    internal class ControlPointsTransformer : IControlPointsTransformer
    {
        ...
        public IControlPoint[] Transform(IControlPoint[] points)
        {
            ...
            {
                controlPoint.Coordinate[0] = Move(controlPoint.Coordinate[0], ButtomLeftCorner[0] + 0.01,
                                                  TopRightCorner[0] - 0.01, XSteps);
                controlPoint.Coordinate[1] = Move(controlPoint.Coordinate[1], ButtomLeftCorner[1] + 0.01,
                                                  TopRightCorner[1] - 0.01, YSteps);
            }
