...
{
    public class UElectrodeBoundControlPoint : ControlPoint<CoefficientProblem>
    {
        private Electrode electrode;
        private double length;

        public UElectrodeBoundControlPoint(CoefficientProblem problem, double weight, Electrode electrode, params double[] coordinate)
