...
{
    public class IEqualityCheckPoint : ControlPoint<CoefficientProblem>
    {
        private Electrode e1;
        private Electrode e2;


        public IEqualityCheckPoint(CoefficientProblem problem, double weight,
        ...
        public override double ApproximateValue(ITwiceDifferentiableFunction func = null)
        {
            ...
            {
                b = Problem.Approximator.Compute(point.Coordinate) *
