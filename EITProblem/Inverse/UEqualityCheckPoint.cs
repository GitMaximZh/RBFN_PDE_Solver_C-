...
{
    public class UEqualityCheckPoint : ControlPoint<CoefficientProblem>
    {
        private Electrode e1;
        private Electrode e2;


        public UEqualityCheckPoint(CoefficientProblem problem, double weight,
        ...
        {
            return new UEqualityCheckPoint(Problem, Weight, e1, e2) { Tag = Tag, Index = Index };
        }
    }
}
