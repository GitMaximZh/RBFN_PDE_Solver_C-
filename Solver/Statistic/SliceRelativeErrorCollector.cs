...
{
    public class SliceRelativeErrorCollector: StatisticCollector
    {
        ...
        public SliceRelativeErrorCollector(Func<IPoint, double> expectedFunc)
            : this(expectedFunc, null)
        {
        }

        public SliceRelativeErrorCollector(Func<IPoint, double> expectedFunc, IPoint[] points)
        {
        ...
        {
            var approximator = iteration.Problem.Network;
