...
{
    public class ActualCoefficientAndNetworkCoefficientGraphicCollector : GraphicCollector
    {
        private readonly IPoint[] _points;
        private readonly Func<IPoint, double> _function;

        public ActualCoefficientAndNetworkCoefficientGraphicCollector(Func<IPoint, double> function, IPoint[] points)
        {
            _points = points;
            _function = function;
        }
